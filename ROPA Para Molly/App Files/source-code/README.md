...
## 🎁 Handoff Package
Everything lives in `ROPA Para Molly/docs/` — three documents, each with one job:

1.  [**MOLLY.md**](ROPA%20Para%20Molly/docs/MOLLY.md) — For Molly: full feature guide, how to test, how to take control. No tech required.
2.  [**TECHNICAL_FRIEND.md**](ROPA%20Para%20Molly/docs/TECHNICAL_FRIEND.md) — For the technical friend: complete deployment, all services, database management.
3.  [**AI_ASSISTANT.md**](ROPA%20Para%20Molly/docs/AI_ASSISTANT.md) — For any AI (ChatGPT/Claude): upload this file to get instant full knowledge of the platform.
