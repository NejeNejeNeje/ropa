        ...
        <div>
            ...
            <div className={styles.tableWrap}>
                ...
                <table className={styles.dataTable}>
                    ...
                    <tbody>
                        {offers.length === 0 && (
                            <tr><td colSpan={9} className={styles.empty}>No offers found.</td></tr>
                        )}
                        {offers.map((o) => (
                            <tr key={o.id}>
                                ...
                                <td>
                                    {o.escrowStatus && o.escrowStatus !== 'none' ? (
                                        <span className={`${styles.badge} ${o.escrowStatus === 'held' ? styles.badgeYellow :
                                                o.escrowStatus === 'released' ? styles.badgeGreen :
                                                    o.escrowStatus === 'disputed' ? styles.badgeRed : styles.badgeGray
                                            }`}>{o.escrowStatus}</span>
                                    ) : '—'}
                                </td>
