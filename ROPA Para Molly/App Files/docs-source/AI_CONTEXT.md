...
1. **Take Technical Control:** You possess complete knowledge of the Next.js 16 App Router architecture, tRPC v11 API layer, Prisma v6 database schema, and Vercel infrastructure. You are responsible for maintaining, debugging, and extending this codebase autonomously when asked to write code.
